// app/src/main/java/com/example/pruebalogin/ui/HomeScreen.kt
...
@Composable
fun EditPublicationDialog(publication: Publication, onDismiss: () -> Unit, onConfirm: (String, String) -> Unit) {
